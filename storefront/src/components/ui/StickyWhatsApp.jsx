...
// Floating WhatsApp click-to-chat button — rendered ONCE in the storefront
// root layout (App.jsx) so it appears on every customer-facing page (Home,
// Shop, Categories, Brand pages, Product details, Cart, Checkout, About,
...
export default function StickyWhatsApp() {
  return (
    ...
    >
      {/* Official WhatsApp glyph — inline SVG (no icon dependency added). */}
      ...
      {/* Small hover tooltip (desktop only, see CSS) — presentational for
          screen readers; the aria-label carries the accessible name. */}
      <span className="sticky-whatsapp-tooltip" aria-hidden="true">
