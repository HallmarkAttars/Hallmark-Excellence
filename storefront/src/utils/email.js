// ============================================================================
// Email validation (frontend UX mirror)
//
// The server holds the AUTHORITATIVE rules (server/src/utils/emailValidation.js
// with the full maintained disposable-domain blocklist + DNS host check) — this
// file only mirrors the format rules and a CURATED subset of well-known
// disposable domains so the UI can fail fast with friendly messages. The
// server always re-validates, so nothing here is a security boundary.
// ============================================================================

// Friendly messages — identical to the server's EMAIL_ERRORS.
...
// Curated disposable/temporary providers for instant UX feedback. The server
// enforces the complete, maintained blocklist on every request.
...
// Trim and lowercase the DOMAIN only — the local part is preserved as typed.
